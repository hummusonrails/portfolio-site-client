            ...
            <div className="content">
              ...
              <Col lg={6} md={6}>
                ...
                <div id="index-content">
                  ...
                  <br />
                  <p id="paragraph2">After a decade of communal service, I've decided to shift my focus back to the tech sector. During the 1990s I co-founded a computer security firm and co-founded Southern California's largest computer security conference. I've returned to my tech roots as a recent graduate of the Flatiron School and now spend my time on open source projects, on freelancing and as an Online Technical Coach at WeWork.</p>
                  <br />
