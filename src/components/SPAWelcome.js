            ...
            <div className="content">
              ...
              <Col lg={6} md={6}>
                ...
                <div id="index-content">
                  ...
                  <br />
                  <p id="paragraph2">After a decade of non-profit communal service, I've come back to the tech sector. During the 1990s I co-founded a information security firm and co-founded Southern California's largest <a href="https://sandiego.toorcon.net/" target="_new">infosec conference</a>. I've returned to my tech roots as a graduate of the Flatiron School and work as a Full Stack Developer at a publicly traded financial services company. I write regularly on technical topics, participate in the local developer community and speak at technical conferences, such as <a href="https://www.youtube.com/watch?v=tTZ3pWoDkjc" target="_new">JSConf EU</a> in Berlin.</p>
                  <br />
